...
//           setPunchData(response.data.punches);
//         } else {
...
//                   {filteredData.filter((r) => r.type === "in").length}
//                 </div>
//               </div>
...
//                     <div className="space-y-2">
//                       <div className="text-red-600 font-semibold">Photo</div>
//                       <div className="bg-gray-50 p-3 rounded-lg">
//                         <img
//                           src={record.photo}
//                           alt={record.type}
...
//                   Details - {formatDate(selectedRecord.createdAt)}
//                 </h2>
//                 <button
//                   onClick={closeModal}
